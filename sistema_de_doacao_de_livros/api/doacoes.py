...
async def criar_doacao(  # noqa: PLR0913, PLR0917
    ...
    for livro_item in livros_data:
        livros.append(
            LivroNaDoacao(
                livro_id=livro_item["livro_id"],
                foto_url=None,
                observacao=livro_item.get("observacao"),
            )
        )

    dados = CriacaoDeDoacao(
    ...
    uploads_dir = Path("sistema_de_doacao_de_livros/web/static/uploads")
...
def _processar_doacao(dados: CriacaoDeDoacao, foto_urls_uploaded: dict):
